...
| Email step | `email.placeholder` `email.save` `email.skip` `email.saved` `email.invalid` `email.unavailable` `email.consentsRequired` `email.savedAs` `email.change` `email.cancel` |
