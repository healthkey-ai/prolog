...
PROLOG_PARTICIPANT_RESOLVER = os.environ.get("PROLOG_PARTICIPANT_RESOLVER") or None
PROLOG_PARTICIPANT_FACTORY = os.environ.get("PROLOG_PARTICIPANT_FACTORY") or None
